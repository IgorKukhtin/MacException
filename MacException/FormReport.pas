...
procedure TReportForm.btnOKClick(Sender: TObject);
begin
  Close;
end;

class function TReportForm.BuildReport(ExceptObject: TObject;
...
class procedure TReportForm.ExceptionAcquiredHandler(Obj: Pointer);
begin
  ShowReport(BuildReport(Obj, ExceptAddr));
end;

class procedure TReportForm.ExceptionHandler(Sender: TObject; E: Exception);
begin
  ShowReport(BuildReport(E, ExceptAddr));
end;

class procedure TReportForm.ExceptProcHandler(ExceptObject: TObject;
  ExceptAddr: Pointer);
begin
...
class procedure TReportForm.RegisterExceptHandler;
begin
  Application.OnException := TReportForm.ExceptionHandler;
  ExceptProc := @TReportForm.ExceptProcHandler;
  ExceptionAcquired := @TReportForm.ExceptionAcquiredHandler;
end;
